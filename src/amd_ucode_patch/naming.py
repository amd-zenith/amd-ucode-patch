...
def ucode_patch_name(patch: UcodePatch, enc_override=None) -> str:
    ...
    name = f"family{patch.header.cpu_family:02x}_cpuid{patch.header.cpuid_str}_rev{patch.header.update_revision:08x}_date{patch.header.date.year:04}{patch.header.date.month:02}{patch.header.date.day:02}"
