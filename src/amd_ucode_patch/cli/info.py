...
def _row_fields(path, patch):
    ...
    return (
        ...
        f"{patch.body.body_header.autorun if patch.body.body_header is not None else ''}",
        f"{patch.body.body_header.encrypted if patch.body.body_header is not None else ''}",
